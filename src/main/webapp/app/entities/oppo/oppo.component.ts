...
import { IDmDienThoai } from '../../shared/model/dm-dien-thoai.model';

@Component({
  selector: 'jhi-dm-dien-thoai-opppo',
  templateUrl: './oppo.component.html',
})
export class OppoComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.dmSanPhamService.queryOppo(this.itemSearch).subscribe(
