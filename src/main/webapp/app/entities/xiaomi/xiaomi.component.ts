...
@Component({
  selector: 'jhi-dm-dien-thoai-xiaomi',
  templateUrl: './xiaomi.component.html',
})
export class DmDienThoaiXiaomiComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    this.dmSanPhamService.queryXiaomi(this.itemSearch).subscribe(
